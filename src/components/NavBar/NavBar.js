  ...
  <Container>
    ...
    <Navbar.Collapse id="basic-navbar-nav">
      <Nav className="me-auto navegacion">
        ...
        <NavDropdown title="Productos" id="collasible-nav-dropdown" className='link-nav'  exact activeClassName="link-activo" >
          <NavDropdown.Item><Nav.Link ><NavLink to="/category/ferreteria" className='link-nav'  exact activeClassName="link-activo"> Ferreteria </NavLink></Nav.Link></NavDropdown.Item>
